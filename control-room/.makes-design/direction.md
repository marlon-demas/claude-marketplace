...
- 2026-06-12 · v0.2.2: light theme added as a tweaks-panel toggle (Theme: dark/light, dark default). body.light swaps the token set to brand-default surfaces; tier-as-text sites derive AA-safe colors via color-mix(in srgb, hue var(--tier-mix), var(--text)) — 100% on dark, 55% on light. Logo follows theme (white ↔ Specno Blue per logo rules).
